...
ad_form -extend -name message -form {
	...
	set sender_firstnames [db_string sender_email "select firstnames from persons where person_id = [ad_get_user_id]" -default "System"]
	set sender_lastname [db_string sender_email "select lastname from persons where person_id = [ad_get_user_id]" -default "Administrator"]
	...
	set lang_server_url [export_vars -base $lang_server_base_url {locale package_key message_key message comment package_version sender_email sender_firstnames sender_lastname}]
